# awesome iOS architecture with stars
...
* [MVCTodo](https://github.com/davedelong/MVCTodo) ⚠️ Archived A very simple "To Do" app to illustrate the principles from my "A Better MVC" talk
...
* [foodMVP](https://github.com/voghDev/foodMVP) ⭐ 9 | 🐛 0 | 🌐 Objective-C | 📅 2016-01-26
* [MVP-iOS](https://github.com/Quaggie/MVP-iOS) ⭐ 0 | 🐛 0 | 🌐 Swift | 📅 2017-03-24
* [MVP](https://github.com/shuilinok/MVP) ⭐ 0 | 🐛 0 | 🌐 Objective-C | 📅 2017-08-29
...
* [Reddit-MVVM-Benchmark](https://github.com/ivanbruel/Reddit-MVVM-Benchmark) ⭐ 439 | 🐛 1 | 🌐 Swift | 📅 2017-08-16 MVVM with FRP Benchmark project
...
* [TheReactiveArchitecture](https://github.com/devxoul/TheReactiveArchitecture) ⭐ 2,786 | 🐛 35 | 🌐 Swift | 📅 2026-05-07 The modern and reactive architecture for RxSwift application
...
* [swift-composable-architecture](https://github.com/pointfreeco/swift-composable-architecture) ⭐ 14,909 | 🐛 25 | 🌐 Swift | 📅 2026-08-28 A library for building applications in a consistent and understandable way, with composition, testing, and ergonomics in mind.
...
* [CleanArchitectureRxSwift](https://github.com/sergdort/CleanArchitectureRxSwift) ⭐ 4,105 | 🐛 2 | 🌐 Swift | 📅 2025-02-12 Example of Clean Architecture of iOS app using RxSwift :rocket:
...
* [Render](https://github.com/alexdrone/Render) ⭐ 2,150 | 🐛 6 | 🌐 Swift | 📅 2019-12-13 Swift and UIKit a la React.
...
* [ReSwift](https://github.com/ReSwift/ReSwift) ⭐ 7,589 | 🐛 50 | 🌐 Swift | 📅 2024-04-22 Unidirectional Data Flow in Swift - Inspired by Redux :star:
* [ReactorKit](https://github.com/ReactorKit/ReactorKit) ⭐ 2,786 | 🐛 35 | 🌐 Swift | 📅 2026-05-07 A framework for reactive and unidirectional Swift application architecture :rocket: :rocket:
...
* [Reactor](https://github.com/jarsen/Reactor) ⭐ 176 | 🐛 3 | 🌐 Swift | 📅 2020-06-13 Unidirectional data flow in Swift
...
* [Aftermath](https://github.com/hyperoslo/Aftermath) ⭐ 71 | 🐛 0 | 🌐 Swift | 📅 2017-03-28 Stateless message-driven micro-framework in Swift
* [ReCombine](https://github.com/ReCombine/ReCombine) ⭐ 46 | 🐛 2 | 🌐 Swift | 📅 2021-10-25 A Swift Redux library utilizing Apple's Combine Framework
* [Highway](https://github.com/cooler333/Highway) ⭐ 45 | 🐛 0 | 🌐 Swift | 📅 2023-11-04 Fast and simple multi-store Redux-like architecture for iOS/OSX applications
* [ReactComponentKit](https://github.com/ReactComponentKit/ReactComponentKit) ⭐ 32 | 🐛 0 | 🌐 Swift | 📅 2019-09-19 ReactComponentKit is a library for building UIViewController based on Components.
...
* [Introduction to VIPER](https://github.com/strongself/The-Book-of-VIPER/blob/master/english/introduction-to-viper.md) ⭐ 959 | 🐛 29 | 📅 2022-11-08
* [Viper Framework for iOS using Swift v3](https://github.com/ferranabello/Viperit) ⭐ 513 | 🐛 5 | 🌐 Swift | 📅 2021-09-15
* [iOSModulesArchitecture](https://github.com/JeanLebrument/iOSModulesArchitecture) ⭐ 29 | 🐛 1 | 🌐 Swift | 📅 2016-04-07 Quick example of how divide an app into modules to respect the SOLID principles
...
* [iOS-Viper-Architecture](https://github.com/MindorksOpenSource/iOS-Viper-Architecture) ⭐ 735 | 🐛 4 | 🌐 Swift | 📅 2024-07-20 A detailed sample app that implements VIPER architecture
* [iOS Viper XCode Templates](https://github.com/infinum/iOS-VIPER-Xcode-Templates) ⭐ 591 | 🐛 3 | 🌐 HTML | 📅 2026-03-27 Another detailed sample app that implements VIPER architecture with code generation templates
* [iOSSwiftStarter](https://github.com/RoRoche/iOSSwiftStarter) ⭐ 76 | 🐛 3 | 🌐 Swift | 📅 2020-04-26 A sample iOS app written in Swift using the VIPER architecture.
* [VIPER-TDD](https://github.com/hendych/VIPER-TDD/) ⭐ 11 | 🐛 0 | 🌐 Swift | 📅 2018-10-26 A sample iOS app written in Swift 4 using VIPER architecture with unit tests.
...
* [AdvancedCollectionView](https://github.com/zwaldowski/AdvancedCollectionView) ⚠️ Archived
...
* [ComponentKit](https://github.com/facebook/componentkit) ⭐ 5,749 | 🐛 27 | 🌐 Objective-C++ | 📅 2024-01-16 A React-inspired view framework for iOS
...
* [Epoxy](https://github.com/airbnb/epoxy-ios) ⭐ 1,318 | 🐛 11 | 🌐 Swift | 📅 2026-07-24 - Epoxy is a suite of declarative UI APIs for building UIKit applications in Swift
...
* [Upstream](https://github.com/onmyway133/Upstream) ⭐ 51 | 🐛 0 | 🌐 Swift | 📅 2020-05-12 ⛲️ Adapted Data Source in Swift and a little bit more :rocket: :rocket:
* [Spots](https://github.com/hyperoslo/Spots) ⭐ 19 | 🐛 0 | 🌐 Swift | 📅 2018-04-12 Spots is a view controller framework that makes your setup and future development blazingly fast :star:
...
* [eigen](https://github.com/artsy/eigen/blob/master/docs/overview.md) ⭐ 3,774 | 🐛 22 | 🌐 TypeScript | 📅 2026-09-16 The Art World in Your Pocket or Your Trendy Tech Company's Tote, Artsy's iOS app
...
* [modular-architecture](https://github.com/bricepollock/modular-architecture) ⚠️ Archived Examples of iOS Modular Architecture in Swift
...
* [JustPersist](https://github.com/justeat/JustPersist) ⚠️ Archived
...
* [RxSwift](https://github.com/ReactiveX/RxSwift) ⭐ 24,645 | 🐛 15 | 🌐 Swift | 📅 2026-09-04 Reactive Programming in Swift
...
* [stripe-ios](https://github.com/stripe/stripe-ios) ⭐ 2,570 | 🐛 291 | 🌐 Swift | 📅 2026-09-16 Stripe iOS SDK
* [line-sdk-ios-swift](https://github.com/line/line-sdk-ios-swift) ⭐ 877 | 🐛 7 | 🌐 Swift | 📅 2026-07-24 Provides a modern way of implementing LINE APIs
...
This project is released under the MIT license. See [LICENSE.md.](https://github.com/onmyway133/awesome-ios-architecture/blob/master/LICENSE) ⭐ 5,268 | 🐛 2 | 📅 2023-11-29
