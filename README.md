...
* [RxCoordinator](https://github.com/quickbirdstudios/RxCoordinator) ⭐ 2,394 | 🐛 18 | 🌐 Swift | 📅 2026-07-02 iOS framework that helps you implement Model-View-ViewModel-Coordinator architecture.
...
* [swift-composable-architecture](https://github.com/pointfreeco/swift-composable-architecture) ⭐ 14,894 | 🐛 25 | 🌐 Swift | 📅 2026-08-28 A library for building applications in a consistent and understandable way, with composition, testing, and ergonomics in mind.
...
* [IGListKit](https://github.com/instagram/IGListKit) ⭐ 13,069 | 🐛 63 | 🌐 Objective-C | 📅 2026-08-19 A data-driven UICollectionView framework for building fast and flexible lists.
...
* [eigen](https://github.com/artsy/eigen/blob/master/docs/overview.md) ⭐ 3,773 | 🐛 26 | 🌐 TypeScript | 📅 2026-09-04 The Art World in Your Pocket or Your Trendy Tech Company's Tote, Artsy's iOS app
...
* [RxSwift](https://github.com/ReactiveX/RxSwift) ⭐ 24,648 | 🐛 13 | 🌐 Swift | 📅 2026-09-04 Reactive Programming in Swift
...
* [XCoordinator](https://github.com/quickbirdstudios/XCoordinator) ⭐ 2,394 | 🐛 18 | 🌐 Swift | 📅 2026-07-02 Powerful navigation library for iOS based on the coordinator pattern
...
* [stripe-ios](https://github.com/stripe/stripe-ios) ⭐ 2,569 | 🐛 288 | 🌐 Swift | 📅 2026-09-04 Stripe iOS SDK
