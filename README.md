...
* [swift-composable-architecture](https://github.com/pointfreeco/swift-composable-architecture) ⭐ 14,893 | 🐛 25 | 🌐 Swift | 📅 2026-08-28 A library for building applications in a consistent and understandable way, with composition, testing, and ergonomics in mind.
...
* [IGListKit](https://github.com/instagram/IGListKit) ⭐ 13,069 | 🐛 62 | 🌐 Objective-C | 📅 2026-08-19 A data-driven UICollectionView framework for building fast and flexible lists.
...
* [eigen](https://github.com/artsy/eigen/blob/master/docs/overview.md) ⭐ 3,773 | 🐛 24 | 🌐 TypeScript | 📅 2026-09-03 The Art World in Your Pocket or Your Trendy Tech Company's Tote, Artsy's iOS app
...
* [RxSwift](https://github.com/ReactiveX/RxSwift) ⭐ 24,649 | 🐛 16 | 🌐 Swift | 📅 2026-08-15 Reactive Programming in Swift
...
* [stripe-ios](https://github.com/stripe/stripe-ios) ⭐ 2,568 | 🐛 288 | 🌐 Swift | 📅 2026-09-04 Stripe iOS SDK
