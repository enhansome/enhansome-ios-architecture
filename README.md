...
* [TheReactiveArchitecture](https://github.com/devxoul/TheReactiveArchitecture) ⭐ 2,785 | 🐛 35 | 🌐 Swift | 📅 2026-05-07 The modern and reactive architecture for RxSwift application
...
* [swift-composable-architecture](https://github.com/pointfreeco/swift-composable-architecture) ⭐ 14,933 | 🐛 23 | 🌐 Swift | 📅 2026-09-18 A library for building applications in a consistent and understandable way, with composition, testing, and ergonomics in mind.
...
* [ReactorKit](https://github.com/ReactorKit/ReactorKit) ⭐ 2,785 | 🐛 35 | 🌐 Swift | 📅 2026-05-07 A framework for reactive and unidirectional Swift application architecture :rocket: :rocket:
...
* [DTTableViewManager](https://github.com/DenHeadless/DTTableViewManager) ⭐ 451 | 🐛 0 | 🌐 Swift | 📅 2024-07-16 Protocol-oriented UITableView management, powered by generics and associated types.
...
* [RIBs](https://github.com/uber/RIBs) ⭐ 7,940 | 🐛 120 | 🌐 Kotlin | 📅 2026-07-15 Uber's cross-platform mobile architecture framework.
* [eigen](https://github.com/artsy/eigen/blob/master/docs/overview.md) ⭐ 3,774 | 🐛 38 | 🌐 TypeScript | 📅 2026-09-23 The Art World in Your Pocket or Your Trendy Tech Company's Tote, Artsy's iOS app
...
* [stripe-ios](https://github.com/stripe/stripe-ios) ⭐ 2,568 | 🐛 324 | 🌐 Swift | 📅 2026-09-24 Stripe iOS SDK
